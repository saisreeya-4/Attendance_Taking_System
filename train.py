...
lbl3 = tk.Label(window, text="Notification : ",width=20  ,fg="blue"  ,bg="gray"  ,height=2 ,font=('times', 15, ' bold ')) 
lbl3.place(x=200, y=300)

message = tk.Label(window, text="" ,bg="gray"  ,fg="blue"  ,width=30  ,height=2, activebackground = "yellow" ,font=('times', 15, ' bold ')) 
message.place(x=500, y=300)

lbl3 = tk.Label(window, text="Attendance : ",width=20  ,fg="blue"  ,bg="gray"  ,height=2 ,font=('times', 15, ' bold ')) 
lbl3.place(x=300, y=550)


message2 = tk.Label(window, text="" ,fg="blue"   ,bg="gray",activeforeground = "green",width=30  ,height=2  ,font=('times', 15, ' bold ')) 
message2.place(x=600, y=550)
...
def TrackImages():
    ...
    fileName="Attendance\Attendance_"+date+"_"+"Time"+"("+Hour+"-"+Minute+"-"+Second+")"+".csv"
